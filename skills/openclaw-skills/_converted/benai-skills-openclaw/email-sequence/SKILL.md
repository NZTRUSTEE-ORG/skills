...
For implementation, see the local converted note at [tools registry](references/tools-registry.md). Key email tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Customer.io** | Behavior-based automation | - | [customer-io.md](references/customer-io.md) |
| **Mailchimp** | SMB email marketing | ✓ | [mailchimp.md](references/mailchimp.md) |
| **Resend** | Developer-friendly transactional | ✓ | [resend.md](references/resend.md) |
| **SendGrid** | Transactional email at scale | - | [sendgrid.md](references/sendgrid.md) |
| **Kit** | Creator/newsletter focused | - | [kit.md](references/kit.md) |
